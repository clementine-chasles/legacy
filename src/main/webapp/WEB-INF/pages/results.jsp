    ...
    <div class="container" style="margin-top: 200px;">
        <div class="row">
            <c:forEach items="${products}" var="p">
                    <div class="col-lg-3 col-sm-6" style="margin-top: 20px; margin-bottom: 10px">
                        <a href="product">
                        <div class="my-box">
                            <div class="product discount">
                                ...
                                <c:if test="${p.sale > 0}"><div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>-${p.sale}%</span></div></c:if>
                                <div class="product_info">
                                    <h6 class="product_name">${p.name}</h6>
                                    <div class="product_price">${p.newPrice}<c:if test="${p.sale > 0}"><span>${p.price}</span></c:if></div>
                                </div>
                            </div>
                        </div>
                        </a>
